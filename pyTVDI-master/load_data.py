...
im.save('C:/Users/Glogta/OneDrive/Uni_current/Special_project/data/Scope/NDVI_scope.tif')

im = Image.fromarray(LST_scope)
im.save('C:/Users/Glogta/OneDrive/Uni_current/Special_project/data/Scope/LST_scope.tif')

im = Image.fromarray(CLM_scope)
im.save('C:/Users/Glogta/OneDrive/Uni_current/Special_project/data/Scope/CLM_scope.tif')
